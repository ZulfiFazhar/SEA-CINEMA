...
<body>
                ...
                if (isset($_SESSION['username'])) {
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        echo '<div class="dropdown me-5">
                                <a class="btn btn-primary dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="background-color: transparent; color: black; border: solid 1px black;">
                                    Hallo, '. $name .'
                                </a>
    ...
    <div class="container">
        ...
        // Menampilkan data dalam card menggunakan Bootstrap
        while ($row = mysqli_fetch_assoc($result)) {
            echo '
            <div class="col-md-4">
                <div class="card my-4" onclick="window.location.href=\'page/movie_detail.php?id=' . $row["id"] . '\'" style="cursor:pointer;">
                    <div class="card-body">
                        <img src="'. $row["poster_url"] . '" alt="poster image" width="100%">
                        <h5 class="card-title">' . $row["title"] . '</h5>
                        <p class="card-text">' . $row["description"] . '</p>
                        <p class="card-text">Ticket Price : ' . $row["ticket_price"] . '</p>
                    </div>
                </div>
            </div>';
        }
